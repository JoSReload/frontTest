...
<body>
	<div class="welcome">
        ...
        <div id="loading" style="border: solid 1px ">Loading Section</div>
        <button onclick="load_login()">Load login</button>

	</div>
    <script src="statics/scripts/vendor.js"></script>
    <script>
        function load_login(){
            var t = $('#loading');
            t.load('admin/login #login-form-wrap', null, null);
        }
    </script>
</body>
</html>
